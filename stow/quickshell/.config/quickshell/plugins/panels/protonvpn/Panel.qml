...
Panel {
  ...
  // Submit sign-in (launches terminal to prompt for password/2FA)
      ...
      Flickable {
        ...
        Column {
          ...
          Text {
            ...
            width: parent.width
            text: "The Proton VPN desktop app is installed. It can't run alongside the CLI this widget uses — quit the app before connecting, or remove it with:  sudo pacman -R proton-vpn-gtk-app"
            color: root.urgent
            font.family: root.fontFamily
            font.pixelSize: Style.font.caption
            wrapMode: Text.WordWrap
