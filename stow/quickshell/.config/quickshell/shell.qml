...
ShellRoot {
  ...
  readonly property string shellPath: omarchyPath !== "" ? (omarchyPath + "/shell") : (home + "/.config/quickshell")
  readonly property string firstPartyPluginsDir: shellPath + "/plugins"
  readonly property string defaultsPath: omarchyPath !== "" ? (omarchyPath + "/config/omarchy/shell.json") : (home + "/.config/omarchy/shell.json")
