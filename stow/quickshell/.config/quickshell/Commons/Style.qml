...
QtObject {
  ...
  property real spacingScale: 1.2
  ...
  readonly property QtObject font: QtObject {
    ...
    readonly property int display:      root.fontToken("display",       root.fontPx(2.667))   // 32
    readonly property int displayLarge: root.fontToken("display-large", root.fontPx(3.333))   // 40

    readonly property int iconSmall:    root.fontToken("icon-small",    root.fontPx(1.333))   // 16
    readonly property int icon:         root.fontToken("icon",          root.fontPx(1.667))   // 20
    readonly property int iconLarge:    root.fontToken("icon-large",    root.fontPx(2.167))   // 26
  }

  readonly property QtObject bar: QtObject {
    readonly property int sizeHorizontal: root.barToken("size-horizontal", 30)
    readonly property int sizeVertical:   root.barToken("size-vertical",   30)
    readonly property int iconSlot:       root.barToken("icon-slot",       32)
    readonly property int iconCanvas:     root.barToken("icon-canvas",     22)
    readonly property int iconFont:       root.barToken("icon-font",       18)
    readonly property int statusSlot:     root.barToken("status-slot",     24)
  }
